...
public class BuyMenu_Adapter2 extends ArrayAdapter {

    public int resourceid;
    public Activity context;
    public ArrayList<BuyMenu_Model2> object;

    public BuyMenu_Adapter2(Activity context, int resource, ArrayList objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView img = view.findViewById(R.id.simple_buy_image2);
        TextView textView = view.findViewById(R.id.simple_buy_text2);
        BuyMenu_Model2 buyMenu_modle = object.get(position);
