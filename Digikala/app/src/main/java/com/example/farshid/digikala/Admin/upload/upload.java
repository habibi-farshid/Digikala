...
//                        Toast.makeText(upload.this, "Response " + response.raw().message(), Toast.LENGTH_LONG).show();
//                        Toast.makeText(upload.this, "Success " + response.body().getSuccess(), Toast.LENGTH_LONG).show();
//                    }
//                    @Override
...
//                @Override
//                public void onResponse(Call<UploadObject> call, Response<UploadObject> response) {
//                    Toast.makeText(upload.this, "Success " + response.message(), Toast.LENGTH_LONG).show();
//                    Toast.makeText(upload.this, "Success " + response.body().toString(), Toast.LENGTH_LONG).show();
//                }
//                @Override
//                public void onFailure(Call<UploadObject> call, Throwable t) {
//                    Log.d(TAG, "Error " + t.getMessage());
